...
class LoginApp(HydraHeadApp):
    ...
    def run(self) -> None:
        ...
        c3.image("resources\ceriapng.png",width=100,)
    ...
    def _create_login_form(self, parent_container) -> Dict:
        ...
        parent_container.write("Klik Login, bukan Enter:sunglasses:")
    ...
    def _do_login(self, form_data, msg_container) -> None:
        ...
        if access_level > 0:
            ...
            msg_container.error(f"❌ Login tidak berhasil, 😕 please cek username dan password atau kontak Adsis.")
    ...
    def _check_login(self, login_data) -> int:
        ...
        if login_data['username'] == 'Pajak' and login_data['password'] == 'ceria':
            return 2
        if login_data['username'] == 'viewer' and login_data['password'] == 'ceria007':
            return 1
        else:
            return 0